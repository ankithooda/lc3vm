...
/* Extend Sign */
int16_t
extend_sign (int16_t value, uint8_t bit_count)
{
...
uint16_t *
get_memory_location (uint16_t offset)
{
  return memory + offset;
}

uint16_t
read_memory (uint16_t address)
{
  return memory[address];
}

void
write_memory (uint16_t address, uint16_t value)
{
...
void
add_instruction (uint16_t instruction)
{
  uint16_t dr, sr1, sr2;
  int16_t imm_value;
...
void
branch_instruction (uint16_t instruction)
{
...
void
ld_instruction (uint16_t instruction)
{
...
void
st_instruction (uint16_t instruction)
{
...
void
jsr_instruction (uint16_t instruction)
{
...
void
and_instruction (uint16_t instruction)
{
  uint16_t dr, sr1, sr2;
  int16_t imm_value;
...
void
not_instruction (uint16_t instruction)
{
  uint16_t dr, sr;
...
void
str_instruction (uint16_t instruction)
{
...
void
ldr_instruction (uint16_t instruction)
{
...
void
ldi_instruction (uint16_t instruction)
{
...
void
sti_instruction (uint16_t instruction)
{
...
void
jmp_instruction (uint16_t instruction)
{
  uint16_t r;
...
void
lea_instruction (uint16_t instruction)
{
  uint16_t dr, pcoffset9;
...
void
trap_instruction (uint16_t instruction)
{
